...
Простое правило расширение формирует фрактальную архитектуру с C переплетенными колонками. В базовом случае _f1(z)_, архитектура имеет один слой выбранного типа, между входом и выходом. Объединяющие слои рассчитывают среднее по элементам.
